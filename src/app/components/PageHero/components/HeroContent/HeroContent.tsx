  ...
  return (
    <div className='flex flex-col gap-y-8 text-center lg:text-left'>
      <p className='text-[clamp(1rem,3dvw,1.5rem)]'>
        Hello, I&apos;m{' '}
        <span className='text-3xl text-[clamp(1.5rem,5dvw,1.875rem)] font-bold tracking-wide underline decoration-primary decoration-4 underline-offset-8 dark:text-highlight'>
          Elgun Mehdiyev
        </span>
      </p>
      <h1 className='text-[clamp(3.5rem,10dvw,8rem)] font-bold leading-none dark:text-highlight'>
        Frontend Developer
      </h1>
